...
<table border="0"><tr valign="top"><td width="310"> <!-- start of frame -->
  ...
  <main class="tmp-base">
		<?php $list_nav_key = 'Manage Users'; $list_nav_bread = 'Add'; include_once 'inc/nav.inc.php';?>
        ...
        <table class="tmp-grid" border="0">
        	...
        	<tr>   
              ...
              <label><x>*</x> Email Address :</label>
					    <input type="email" name="email" value="<?php echo $_POST['email']; ?>" placeholder="Ex. example@domain.com" required />
            </td>            
          	<!-- <td colspan="2">
